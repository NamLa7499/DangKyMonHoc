...
namespace WebDangKyMonHoc.Models
{
    ...
    public partial class DangKyMonHocEntities : DbContext
    {
        public DangKyMonHocEntities()
            : base("name=DangKyMonHocEntities")
        {
        }
        ...
        public virtual DbSet<ChiTietChuongTrinhHoc> ChiTietChuongTrinhHocs { get; set; }
        public virtual DbSet<ChuongTrinhHoc> ChuongTrinhHocs { get; set; }
        public virtual DbSet<DotDangKy> DotDangKies { get; set; }
