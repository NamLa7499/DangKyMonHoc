...
namespace WebDangKyMonHoc.Controllers
{
    public class MonHocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaMH,TenMH,MaKhoa,HocKy,SoTinChi")] MonHoc monHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaMH,TenMH,MaKhoa,HocKy,SoTinChi")] MonHoc monHoc)
        {
            if (ModelState.IsValid)
            {
